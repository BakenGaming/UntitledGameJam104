...
public class ExperienceSystem
{
    ...
    public int GetNextLevel(){return expNextLevel;}
    public float GetExpPercent(){return (float)currentExp / (float)expNextLevel;}
    public void TriggerLevelUpInEditor(){OnLevelUp?.Invoke();}
}
